			...
			<div class="collapse navbar-collapse"
				...
				?>
	              <!-- 로그인 전 -->
					...
					<li><form name="form1" style="margin-top: 30px" method="post"
							action="../product/product_search.php">
							<td width="135"><input type="text" name="findtext" maxlength="40"
								size="18"></td>
						</form></li>
					<!-- form1 끝 -->
					<li><td width="65"><a href="javascript:Search()"
							style="padding-left: 10px"><img src="../img/i_search1.gif"
								border="0"></a></td></li>
	            <?php
				} else {
				?>
	              <!-- 로그인 후 -->
					...
					<li><td width="65"><a href="javascript:Search()"
							style="padding-left: 10px"><img src="../img/i_search1.gif"
								border="0"></a></td></li>
					<td width="181" align="center"><font color="#666666">&nbsp <b>Welcome ! &nbsp;<?=$_SESSION ['login_user']?> 고객님.</b></font></td>
	            <?php
				}
				?>
	            </ul>
